...
public class Nbex {
	...
	public static void main (String [] args) throws FileNotFoundException {
		...
		File test = new File ("/opt/dropbox/17-18/473/project5/extra-test.txt");
	...
	public static void classify (Integer sum, Table<String, String, Integer> model, Map <String, Integer> langCount, String[] langType, String[] testStrg)
	{
		...
		Set<Double>rSet = output.keySet();
		
		Double[] keyArr = rSet.toArray(new Double[rSet.size()]);
	...
	public static double calCV (Double array[]) 
	{
		...
		for (double n:array)
		{
		 ...
		 Cv = ((Math.sqrt(Sd/array.length))/mean)*100;
